...
#define TFA1_BITNAMETABLE static tfaBfName_t Tfa1BitNames[] = {\
	...
	{ 0xb07, "mtpkey2"},    /* 5Ah, 90d To access KEY1_Protected registers (), */\
	{ 0xc00, "enbl_volt_sense"},    /* Voltage sense enabling control bit                , */\
	{ 0xc10, "vsense_pwm_sel"},    /* Voltage sense PWM source selection control        , */\
	{ 0xc25, "vi_frac_delay"},    /* Fractional delay adjustment between current , */\
	{ 0xc80, "sel_voltsense_out"},    /* TDM output data selection control                 , */\
	{ 0xc90, "vsense_bypass_avg"},    /* Voltage Sense Average Block Bypass       , */\
	{ 0xd05, "cf_frac_delay"},/*Fractional delay adjustment between current ,*/\
	{ 0xe00, "bypass_dcdc_curr_prot"},/* Control to switch off dcdc current , */\
	...
	{ 0x43a0, "ocptestbst"}, /*For old ocp (ctrl_reversebst is 0);For new ocp (ctrl_reversebst is 1);, */\
