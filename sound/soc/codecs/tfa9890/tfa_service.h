...
#define TFA_SET_BF_VALUE(dev_idx, fieldname, bf_value, p_reg_value) tfa_set_bf_value(TFA_FAM(dev_idx,\
						fieldname), bf_value, p_reg_value)
 ...
 * @param force indicates a full system startup should be allowed
 * @param profile the profile that should be loaded
 */
