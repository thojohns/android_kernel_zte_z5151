...
#define GC2375_SENSOR_INFO_MODULE_ID_SUNWIN		0xA1
#define GC2375_SENSOR_INFO_MODULE_ID_SHINE_TECH	0xA2


MODULE_Map_Table GC2375_MODULE_MAP[] = {
	{ GC2375_SENSOR_INFO_MODULE_ID_SUNWIN,
		"sunwin_gc2375", "sunwin_gc2375", NULL},
	{ GC2375_SENSOR_INFO_MODULE_ID_SHINE_TECH,
		"shine_tech_gc2375", "shine_tech_gc2375", NULL},
};
...
#define GC2375_START_ADDR 0x0DFC

#define CS_SLAVE_AWB_S_ADDR GC2375_START_ADDR
#define CS_SLAVE_AWB_E_ADDR 0xE0B
#define CS_SLAVE_AWB_ADDR (CS_SLAVE_AWB_E_ADDR+1)

#define CS_SLAVE_LSC_S_ADDR 0xE0D
#define CS_SLAVE_LSC_E_ADDR 0x14F4
#define CS_SLAVE_LSC_ADDR (CS_SLAVE_LSC_E_ADDR + 1)


#define GC2375_ID_H_ADDR GC2375_START_ADDR
#define GC2375_ID_L_ADDR (GC2375_START_ADDR + 1)
...
void imx351_parse_module_name(struct msm_eeprom_ctrl_t *e_ctrl)
{
	...
	sensor_module_id = (e_ctrl->cal_data.mapdata[GC2375_ID_H_ADDR] << 8)
								| e_ctrl->cal_data.mapdata[GC2375_ID_L_ADDR];
	parse_module_name(&(e_ctrl->module_info[1]), GC2375_MODULE_MAP,
		sizeof(GC2375_MODULE_MAP) / sizeof(MODULE_Map_Table),
		sensor_module_id);
}
...
static const struct of_device_id imx351_eeprom_dt_match[] = {
	{ .compatible = "zte,imx351-eeprom", .data = &imx351_eeprom_func_tbl},
};
