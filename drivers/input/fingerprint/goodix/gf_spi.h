...
#define GF_NAV_INPUT_UP			251
#define GF_NAV_INPUT_DOWN		252
#define GF_NAV_INPUT_LEFT		253
#define GF_NAV_INPUT_RIGHT		254

#define GF_NAV_INPUT_CLICK 		KEY_FINGER_SINGLE_CLICK
#define GF_NAV_INPUT_DOUBLE_CLICK		KEY_FINGER_DOUBLE_CLICK
#define GF_NAV_INPUT_LONG_PRESS		KEY_FINGER_LONG_PRESS
/*
