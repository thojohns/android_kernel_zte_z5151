...
unsigned char FT3C47_TestItem_ForceTouch_SCapCbTest(bool *bTestResult)
{
	...
	test_data.testresult_len +=
	    snprintf(test_data.testresult + test_data.testresult_len, PAGE_SIZE, "Force Touch SCap CB Test is %s.\n\n",
		    (btmpresult ? "OK" : "NG"));
...
TEST_ERR:
	...
	*bTestResult = false;
	FTS_TEST_INFO("\n\nForce Touch SCap CB Test is NG!");
	test_data.testresult_len +=
	    snprintf(test_data.testresult + test_data.testresult_len, PAGE_SIZE, "Force Touch SCap CB Test is NG.\n\n");
	return ReCode;
}
