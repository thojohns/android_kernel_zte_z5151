...
extern	int hx_ED_event_flag;
	...
	#define HIMAX_PROC_TOUCH_INFO		"touchscreen"
	#define HIMAX_PROC_TOUCH_INFO_FILE		"ts_information"
#endif
...
#ifndef CONFIG_TP_COMMON_INTERFACE
	static struct proc_dir_entry *himax_touch_touch_info_proc_dir			= NULL;
	static struct proc_dir_entry *himax_proc_touchinfo_file		= NULL;
#endif
	uint8_t HX_PROC_SEND_FLAG;
	uint8_t HX_PROC_SEND_FLAG_READ;
...
extern uint8_t ito_get_result_status(void);
	...
	#define UPGRADE_FW_BUF_SIZE (128 * 1024)
...
#define HIMAX_PROC_SMWP_FILE "wake_gesture"/*SMWP*/
