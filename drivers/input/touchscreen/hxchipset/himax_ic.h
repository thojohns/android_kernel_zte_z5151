...
int himax_register_read(struct i2c_client *client, uint8_t *read_addr,
int read_length, uint8_t *read_data, bool cfg_flag); /*RegisterRead83110*/
void himax_flash_read(struct i2c_client *client, uint8_t *reg_byte, uint8_t *read_data); /*himax_83110_Flash_Read*/
int himax_flash_write_burst(struct i2c_client *client,
uint8_t *reg_byte, uint8_t *write_data); /*himax_83110_Flash_Write_Burst*/
void himax_flash_write_burst_length(struct i2c_client *client,
uint8_t *reg_byte, uint8_t *write_data, int length); /*himax_83110_Flash_Write_Burst_length*/
void himax_register_write(struct i2c_client *client, uint8_t *write_addr,
int write_length, uint8_t *write_data, bool cfg_flag); /*RegisterWrite83110*/
...
uint8_t *FW_content, int FW_Size); /*himax_83110_Flash_Programming*/
...
void himax_set_reload_cmd(uint8_t *write_data, int idx, uint32_t cmd_from,
uint32_t cmd_to, uint32_t cmd_beat);/*5442 SetReloadCmd*/
/*5442 Flash_Page_Write*/
void himax_flash_page_write(struct i2c_client *client, uint8_t *write_addr, uint8_t *write_data);
uint32_t himax_XX42_check_CRC(struct i2c_client *client,
uint8_t *start_addr, int reload_length);/*5442 XX42_Check_CRC*/
