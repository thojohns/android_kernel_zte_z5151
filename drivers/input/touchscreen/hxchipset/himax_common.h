...
/* for MTK special platform.If turning on,it will report to system by using specific format.*/
...
#define HX_VENDOR_ID_BOE 0
#else
#define HX_VENDOR_ID_DIJING 0
#define HX_VENDOR_ID_LEAD 1
#define HX_VENDOR_ID_XINLI 2
#endif
#endif
...
/*#define FIX_HX_RX_NUM_DIJING 36*/
/*#define FIX_HX_RX_NUM_LEAD 30*/
/*#define FIX_HX_RX_NUM_BOE 36*/
