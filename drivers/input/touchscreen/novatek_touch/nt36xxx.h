...
#include "novatek_firmware_config.h"
...
typedef enum {
	WITHOUT_CHARGER_SWITCH = 0, /* switch to no charger*/
	WITH_CHARGER_SWITCH = 1,	/* switch to no charger */
	NO_CHARGER_CHANGE_SWITCH = 2,	/* no switch*/
} NVT_CHARGER_STATE;
#endif
