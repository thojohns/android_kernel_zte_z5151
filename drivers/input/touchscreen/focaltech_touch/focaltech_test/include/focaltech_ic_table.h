...
/*-----------------------------------------------------------
IC corresponding code, each of the IC code is 8 bit, high 4 bit on behalf of the same series,
low 4 bit on behalf of the specific IC
-----------------------------------------------------------*/
enum IC_Type {
	IC_FT5X36 = 0x10,
	IC_FT5X36i = 0x11,
...
extern unsigned int fts_ic_table_get_chip_id_from_ic_code(unsigned int ic_code,
							  unsigned char *chip_id, unsigned char *chip_id2);
