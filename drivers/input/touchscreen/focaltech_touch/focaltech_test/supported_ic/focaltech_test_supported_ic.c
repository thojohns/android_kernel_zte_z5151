...
void fts_test_funcs(void)
{
	...
	g_stTestFuncs.get_tp_channel = FT5X46_get_tp_channel;	/*  tp test */
	g_stTestFuncs.get_tp_node_data = FT5X46_get_tp_node_data;
...
void fts_test_funcs(void)
{
	...
	g_stTestFuncs.get_tp_channel = FT6X36_get_tp_channel;	/*  tp test */
	g_stTestFuncs.get_tp_node_data = FT6X36_get_tp_node_data;
	FTS_TEST_FUNC_EXIT();
}
...
void fts_test_funcs(void)
{
	...
	g_stTestFuncs.get_tp_channel = FT8006_get_tp_channel;	/*  tp test */
	g_stTestFuncs.get_tp_node_data = FT8006_get_tp_node_data;
	FTS_TEST_FUNC_EXIT();
}
