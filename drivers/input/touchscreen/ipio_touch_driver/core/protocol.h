...
enum ilitek_protocal_key {
	ILITEK_SENSE_CTRL_KEY = 0,
	ILITEK_SLEEP_CTRL_KEY = 1,
	ILITEK_GLOVE_CTRL_KEY = 2,
	ILITEK_STYLUS_CTRL_KEY = 3,
	ILITEK_TP_SCAN_MODE_KEY = 4,
	ILITEK_LPWG_CTRL_KEY = 5,
	ILITEK_GESTURE_CTRL_KEY = 6,
	ILITEK_PHONE_COVER_CTRL_KEY = 7,
	ILITEK_FINGER_SENSE_CTRL_KEY = 8,
	ILITEK_PHONE_COVER_WINDOW_KEY = 9,
	ILITEK_FINGER_SENSE_CTRL1_KEY = 10,
	ILITEK_PROXIMITY_CTRL_KEY = 11,
	ILITEK_PLUG_CTRL_KEY = 12,
	ILITEK_MAX_KEY = ILITEK_PLUG_CTRL_KEY,
};
