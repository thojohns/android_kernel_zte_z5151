...
#define PRINTF_EMERG(fmt, ...)  pr_info(pr_fmt(fmt), ##__VA_ARGS__)
#define PRINTF_ALERT(fmt, ...)  pr_info(pr_fmt(fmt), ##__VA_ARGS__)
#define PRINTF_CRIT(fmt, ...)   pr_info(pr_fmt(fmt), ##__VA_ARGS__)
#define PRINTF_ERR(fmt, ...)    pr_info(pr_fmt(fmt), ##__VA_ARGS__)
#define PRINTF_WARN(fmt, ...)   pr_info(pr_fmt(fmt), ##__VA_ARGS__)
#define PRINTF_NOTICE(fmt, ...) pr_info(pr_fmt(fmt), ##__VA_ARGS__)
#define PRINTF_INFO(fmt, ...)   pr_info(pr_fmt(fmt), ##__VA_ARGS__)
#define PRINTF_DEBUG(fmt, ...)  pr_info(pr_fmt(fmt), ##__VA_ARGS__)
