...
extern s32 /*__devinit*/ MsDrvInterfaceTouchDeviceProbe(struct i2c_client *pClient,
...
extern int MsDrvInterfaceTouchDeviceFbNotifierCallback(struct notifier_block *pSelf,
