...
/*for MSG26xxM/MSG28xx. It is a predefined maximum packet length,
...
#if 0				/*zhangjian remove to mstar_config_sw_id.h */
#ifdef CONFIG_UPDATE_FIRMWARE_BY_SW_ID
typedef struct {
	u16 nSwId;
...
extern void DrvFwCtrlGetCustomerFirmwareVersionByDbBus(EmemType_e eEmemType, u16 *pMajor, u16 *pMinor,
						       u8 **ppVersion);
