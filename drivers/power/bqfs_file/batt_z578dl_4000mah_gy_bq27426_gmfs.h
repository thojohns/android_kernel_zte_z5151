...
/* this file is generated from ZTE_Z578_coslight_1880_ZTE extNTC_learned_Rbteak_DF3.gm.fs at Mon Apr  9 16:50:51 2018 */

#ifndef __BQFS_GY_FILE__
#define __BQFS_GY_FILE__

#include "../bqfs_cmd_type.h"

const bqfs_cmd_t bqfs_coslight_gy[] = {
	{
		.cmd_type	= CMD_W,
		.addr		= 0xAA,
		.reg		= 0x00,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x42, 0x25, 0x00, 0x00, 0x00, 0x81, 0x0F, 0xA0, 0x3B, 0xB0,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x18, 0x80, 0x11, 0x2B, 0xDA, 0xDC, 0xE0, 0xE0, 0xE1, 0xE2,
						0xE3, 0xE4, 0xE5, 0xE4, 0xE6, 0xE1, 0xDF, 0xEC, 0xEC, 0xE7,
						0xEB, 0xE6, 0xEE, 0xF0, 0xF3, 0xF4, 0xF6, 0xF7, 0xFA, 0xF9,
						0xFA, 0xFD} },
		.data_len	= 32,
	},
	{
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xF8, 0xF6, 0xF7, 0xF6, 0xF1, 0xEF, 0xF6, 0xFD, 0xFD, 0xE3,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFC, 0x0F, 0x05, 0x10, 0x0B, 0x05, 0x05, 0x02, 0x00, 0xFD,
						0xFE, 0xFB, 0x06, 0x03, 0x13, 0x18, 0xFE, 0xFF, 0xFF, 0xF4,
						0xF1, 0xF1, 0x04, 0xFF, 0x01, 0x00, 0xFF, 0xF9, 0x00, 0xF9,
						0xEE, 0xF1} },
		.data_len	= 32,
	},
	{
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xF8, 0x00, 0xFD, 0x03, 0xED, 0x12, 0x03, 0xF6, 0xBE, 0x80,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00} },
		.data_len	= 32,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFF, 0x3D, 0x00, 0x19, 0x01, 0xF0, 0x20, 0x15, 0xEF, 0xE7,
						0x34, 0xF3, 0xE3, 0x13, 0x16, 0xD7, 0x75, 0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00} },
		.data_len	= 32,
	},
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFE, 0x6B, 0x00, 0x00, 0x10, 0x25, 0x09, 0xED, 0xF1, 0xDF,
						0x02, 0x00, 0xF5, 0x08, 0x13, 0x3B, 0xEF, 0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00} },
		.data_len	= 32,
	},
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x00, 0x2A, 0x00, 0x2A, 0x00, 0x29, 0x00, 0x32, 0x00, 0x2E,
						0x00, 0x21, 0x00, 0x29, 0x00, 0x28, 0x00, 0x25, 0x00, 0x27,
						0x00, 0x2B, 0x00, 0x29, 0x00, 0x32, 0x00, 0x3E, 0x00, 0x58,
						0x00, 0x00} },
		.data_len	= 32,
	},
	{
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x0F, 0xE9, 0x0E, 0xE5, 0x0E, 0xAF, 0x11, 0x22, 0x10, 0xFC,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00} },
		.data_len	= 32,
