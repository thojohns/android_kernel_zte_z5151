...
/* this file is generated from ZTE Z5250 Learned ext NTC FullID DF3.gm.fs at Thu Nov 30 13:39:10 2017 */
...
const bqfs_cmd_t bqfs_coslight[] = {
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x64, 0x79, 0x0F, 0x9E, 0x23, 0x03, 0x00, 0x14, 0x04, 0x00,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x40, 0xA8, 0x00, 0x00, 0x00, 0x81, 0x0F, 0xA0, 0x3C, 0x28,
						0x0D, 0x48, 0x00, 0xC8, 0x00, 0x32, 0x00, 0x14, 0x03, 0xE8,
						0x01, 0x00, 0xEB, 0x00, 0x0A, 0xFF, 0xCE, 0xFF, 0xCD, 0x00,
						0x02, 0x00} },
		.data_len	= 32,
	},
	{
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x17, 0x39, 0x11, 0x2D, 0xD7, 0xD9, 0xDF, 0xE0, 0xE2, 0xE2,
						0xE4, 0xE3, 0xE6, 0xE6, 0xE0, 0xE4, 0xE2, 0xE8, 0xF4, 0xEC,
						0xE1, 0xEC, 0xE6, 0xF2, 0xF1, 0xF7, 0xF5, 0xF9, 0xF6, 0xFC,
						0xFD, 0xFC} },
		.data_len	= 32,
	},
	{
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFE, 0xF7, 0xF7, 0xF2, 0xF1, 0xEC, 0xF6, 0xFE, 0xF9, 0xE6,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFB, 0x08, 0x05, 0x0A, 0x05, 0x05, 0x00, 0x00, 0x00, 0xFE,
						0x01, 0xF7, 0xFA, 0x15, 0x09, 0x11, 0x04, 0xED, 0xF5, 0x10,
						0xF9, 0xFE, 0x00, 0x07, 0xFB, 0x03, 0xFB, 0x06, 0xF8, 0xF6,
						0xEE, 0xE5} },
		.data_len	= 32,
	},
	{
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFA, 0xFA, 0x06, 0x07, 0x00, 0x0E, 0x00, 0xEB, 0xBB, 0x81,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00} },
		.data_len	= 32,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFF, 0x5B, 0x00, 0x0B, 0xFF, 0xEF, 0x10, 0x1A, 0x04, 0xF8,
						0x05, 0xFA, 0xF9, 0x09, 0x05, 0xBB, 0xE9, 0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00} },
		.data_len	= 32,
	},
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFE, 0x2D, 0x00, 0x05, 0x12, 0x3A, 0x17, 0xC4, 0x00, 0xB6,
						0xEC, 0xF5, 0xFF, 0xE5, 0xEE, 0x08, 0xBE, 0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00} },
		.data_len	= 32,
	},
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x00, 0x2C, 0x00, 0x2C, 0x00, 0x2D, 0x00, 0x33, 0x00, 0x31,
						0x00, 0x26, 0x00, 0x29, 0x00, 0x28, 0x00, 0x29, 0x00, 0x2C,
						0x00, 0x2D, 0x00, 0x31, 0x00, 0x39, 0x00, 0x5C, 0x02, 0x74,
						0x00, 0x00} },
		.data_len	= 32,
	},
	{
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x0F, 0xCA, 0x0E, 0xE4, 0x0E, 0xA4, 0x11, 0x24, 0x10, 0xFB,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00} },
		.data_len	= 32,
