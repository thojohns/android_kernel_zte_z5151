...
const bqfs_cmd_t battery_data_Li3930T44P8h826636_346679_COS_3010mAh_4400mV_image[] = {
	{
		.cmd_type	= CMD_W,
		.addr		= 0xAA,
		.reg		= 0x00,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x64, 0x79, 0x0F, 0x86, 0x23, 0x02, 0x00, 0x14, 0x04, 0x00,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x01, 0x2D, 0x01, 0x78, 0x07, 0xD0, 0x00, 0x3C, 0x3C, 0x01,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x40, 0xDA, 0x00, 0x00, 0x00, 0x81, 0x0B, 0xC2, 0x2D, 0x46,
			0x0D, 0x48, 0x00, 0xC8, 0x00, 0x32, 0x00, 0x14, 0x03, 0xE8,
			0x01, 0x00, 0xC8, 0x00, 0x0A, 0xFF, 0xCE, 0xFF, 0xCE, 0x00,
			0x02, 0x00} },
		.data_len	= 32,
	},
	{
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x19, 0x10, 0x11, 0x2E, 0xDC, 0xDF, 0xDF, 0xE0, 0xE2, 0xE2,
			0xE4, 0xE3, 0xE7, 0xE4, 0xEE, 0xDD, 0xCC, 0xEA, 0xF6, 0xE6,
			0xE9, 0xEA, 0xEB, 0xF3, 0xF1, 0xF5, 0xF5, 0xF8, 0xF8, 0xFB,
			0xF9, 0xFC} },
		.data_len	= 32,
	},
	{
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFA, 0xF7, 0xF7, 0xF6, 0xF2, 0xF0, 0xF4, 0xFC, 0xFE, 0xE7,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFB, 0x3E, 0x04, 0x28, 0x10, 0x11, 0x0A, 0xFF, 0x01, 0xF6,
			0x03, 0xE6, 0x0A, 0x0D, 0x28, 0x4D, 0x0B, 0xF6, 0xF1, 0xC4,
			0xFB, 0xF2, 0xF6, 0x09, 0xFF, 0xFF, 0xF9, 0xF6, 0xF6, 0xF6,
			0xD2, 0xE0} },
		.data_len	= 32,
	},
	{
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xE9, 0xF4, 0x09, 0x08, 0x01, 0xF9, 0x0C, 0x06, 0x18, 0x7F,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00} },
		.data_len	= 32,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFF, 0x1D, 0x00, 0x22, 0xF9, 0x02, 0x0E, 0x20, 0xFB, 0xE3,
			0x38, 0xC7, 0x05, 0x11, 0xEC, 0x38, 0x80, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00} },
		.data_len	= 32,
	},
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFE, 0x1D, 0x00, 0x0D, 0x11, 0x51, 0xE7, 0xC1, 0x2F, 0xC6,
			0xD8, 0x43, 0xC1, 0xC8, 0xF9, 0x05, 0x7F, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00} },
		.data_len	= 32,
	},
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x00, 0x6A, 0x00, 0x36, 0x00, 0x34, 0x00, 0x43, 0x00, 0x37,
			0x00, 0x29, 0x00, 0x35, 0x00, 0x2C, 0x00, 0x27, 0x00, 0x32,
			0x00, 0x31, 0x00, 0x2E, 0x00, 0x37, 0x00, 0x3C, 0x00, 0x90,
			0x00, 0x00} },
		.data_len	= 32,
	},
	{
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x0C, 0x0E, 0x0E, 0xE4, 0x0E, 0xB0, 0x11, 0x24, 0x10, 0x9A,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00} },
		.data_len	= 32,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x07, 0x00, 0x00, 0x00, 0xB7, 0x15, 0xF8, 0x80, 0xCB, 0x4F,
