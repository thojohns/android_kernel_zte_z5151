...
/* this file is generated from ZTE V900 ChemID 1866 ZTE NTC learned DF3.gm.fs.gm.fs at Thu Mar  8 10:10:45 2018 */
...
const bqfs_cmd_t bqfs_coslight[] = {
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x41, 0x0F, 0x00, 0x00, 0x00, 0x81, 0x0C, 0x80, 0x30, 0x0C,
						0x0D, 0x48, 0x00, 0xC8, 0x00, 0x32, 0x00, 0x14, 0x03, 0xE8,
						0x01, 0x00, 0xA0, 0x00, 0x0A, 0xFF, 0xCE, 0xFF, 0xCD, 0x00,
						0x02, 0x00} },
		.data_len	= 32,
	},
	{
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x18, 0x66, 0x11, 0x2D, 0xDA, 0xD9, 0xE1, 0xE0, 0xE1, 0xE1,
						0xE4, 0xE5, 0xE7, 0xE6, 0xDC, 0xDB, 0xEA, 0xE9, 0xF0, 0xED,
						0xE2, 0xE8, 0xED, 0xEF, 0xF3, 0xF3, 0xF7, 0xF8, 0xFA, 0xFA,
						0xFC, 0xFD} },
		.data_len	= 32,
	},
	{
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFB, 0xFB, 0xF4, 0xF5, 0xF1, 0xEC, 0xF4, 0xFC, 0xFB, 0xDC,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFB, 0x0B, 0x04, 0x12, 0x1B, 0xFA, 0x00, 0x07, 0x06, 0xFC,
						0xF3, 0xEA, 0xF2, 0x40, 0x4C, 0xFA, 0xFE, 0xE7, 0xF6, 0xFB,
						0xF2, 0x06, 0xFD, 0x07, 0x08, 0xFF, 0xF5, 0xF9, 0xF2, 0xE8,
						0xD9, 0xD6} },
		.data_len	= 32,
	},
	{
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xD9, 0x1B, 0x00, 0x0A, 0xFF, 0x22, 0x05, 0xF2, 0xD2, 0x81,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00} },
		.data_len	= 32,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFF, 0x33, 0x00, 0x20, 0xD8, 0x32, 0x01, 0xFC, 0x0F, 0xF2,
						0x0E, 0xF4, 0xF5, 0xF7, 0x28, 0xD2, 0xCB, 0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00} },
		.data_len	= 32,
	},
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFE, 0x2C, 0x02, 0x03, 0x02, 0x11, 0xFF, 0xF7, 0x00, 0xE7,
						0x03, 0xF4, 0x02, 0xF8, 0xF5, 0x03, 0x57, 0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00} },
		.data_len	= 32,
	},
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x00, 0x3C, 0x00, 0x38, 0x00, 0x3A, 0x00, 0x42, 0x00, 0x3A,
						0x00, 0x2E, 0x00, 0x34, 0x00, 0x31, 0x00, 0x35, 0x00, 0x3A,
						0x00, 0x41, 0x00, 0x47, 0x00, 0x50, 0x00, 0x7F, 0x01, 0x44,
						0x00, 0x00} },
		.data_len	= 32,
	},
	{
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x0C, 0x53, 0x0E, 0xE4, 0x0E, 0x94, 0x11, 0x22, 0x10, 0xFB,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
						0x00, 0x00} },
		.data_len	= 32,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x05, 0x00, 0x00, 0x00, 0xB7, 0x15, 0xF8, 0x80, 0xCB, 0x4F,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFF, 0xFF, 0x0B, 0xD6, 0x7E, 0x73, 0xB6, 0x45, 0x93, 0x0A,
